...
public class CompaniesDataPojo {
	...
	public CompaniesDataPojo(Integer id, String company_name, Double company_rating, String company_industry, String company_worth, Collection<Locations> locationList, Collection<Experiences> experienceList ){
		this.id = id;
