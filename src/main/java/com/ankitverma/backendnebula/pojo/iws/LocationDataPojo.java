...
public class LocationDataPojo {
	...
	public LocationDataPojo(Integer id, String street_address1, String street_address2, String city, String state, String zipcode, String country,Collection<User> userList, Collection<Highschool> highschoolList, Collection<Qualification> qualificationList, Collection<Companies> companyList){
		this.id = id;
